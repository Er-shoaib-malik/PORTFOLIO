     ...
     border-emerald-400 rounded-full h-16 w-16 mt-20 flex text-center place-items-center pl-2.5 text-cyan-300"
        ...
        <div className="pt-4 pb-2">
          <a 
            href="/resume.pdf" 
            download 
            className="px-4 py-2 bg-gradient-to-r from-orange-400 to-emerald-400 border-none text-black  text-xl rounded-full shadow flex max-w-35 transition linear hover: text-white"
          >
